...
<main class="Customize-Main">
    <section id="pizza-builder">
        ...
        if (mysqli_num_rows($resultflavour) > 0) {
        ...
        if (mysqli_num_rows($resultcrust) > 0) {
            echo '
                <div class="size-section">
                    <h4>Crust</h4>
            ...
            while ($row = mysqli_fetch_assoc($resultcrust)) {
                echo '<option value="' . htmlspecialchars($row['crust_name']) . '" data-price="'
                    . htmlspecialchars($row['crust_price']) . '">' . htmlspecialchars($row['crust_name'])
                    . ' - ' . htmlspecialchars($row['crust_price']) . ' Rs</option>';
            }
