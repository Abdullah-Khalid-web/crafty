...
if (isset($_POST['checkout'])) {
    ...
    $sql = "INSERT INTO orders (user_id, subtotal, shipping_fee, total, user_address, user_phoneno)
            VALUES ('$user_id', '$subtotal', '$shipping_fee', '$total', '$user_address', '$user_phoneno')";
...
<!-- <button type="submit" name="order_now" class="checkout-btn" id="order-button" class="order-button"> <a href="product_order.php">Order Now</a> </button> -->
